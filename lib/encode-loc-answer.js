import {strictEqual as eql} from 'node:assert/strict'
...
const encodeLOCAnswer = (_) => {
	...
	if (_.size !== null) eql(typeof _.size, 'number', 'size')
	if (_.hPrecision !== null) eql(typeof _.hPrecision, 'number', 'hPrecision')
	if (_.vPrecision !== null) eql(typeof _.vPrecision, 'number', 'vPrecision')
	...
	// "worldwide" size.
	const size = _.size === null ? DEFAULT_SIZE : _.size
	...
	// divide by 2.)
	const hPrecision = _.hPrecision === null ? DEFAULT_H_PREC : _.hPrecision
	...
	// adjusted.
	const vPrecision = _.vPrecision === null ? DEFAULT_V_PREC : _.vPrecision
